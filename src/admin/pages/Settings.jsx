    ...
    <Section title="الإعدادات" en="Settings" purpose="من يشوف هذي اللوحة، ووش تتبّعه المنصة فعلًا.">
      ...
      <Panel title="قواعد هذي اللوحة">
        <ul className="ad-rules">
          ...
          <li>
            ما فيه فلتر Production/Staging لأن المنتج نفسه ما فيه بيئة Staging منفصلة — Netlify ومشروع Supabase
            واحد لكل شيء. إضافة الفلتر بدون بيئتين حقيقيتين خلفه كانت راح تكون عنصر واجهة بلا وظيفة، وهذا يخالف
            نفس مبدأ عدم اختلاق البيانات.
          </li>
        </ul>
      </Panel>
    </Section>
